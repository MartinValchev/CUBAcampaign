...
public class CampaignTestContainer extends TestContainer {

    public CampaignTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/campaign/app.properties",
    ...
    public static class Common extends CampaignTestContainer {

        public static final CampaignTestContainer.Common INSTANCE = new CampaignTestContainer.Common();
