...
public class SalesnewTestContainer extends TestContainer {

    public SalesnewTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/salesnew/app.properties",
    ...
    public static class Common extends SalesnewTestContainer {

        public static final SalesnewTestContainer.Common INSTANCE = new SalesnewTestContainer.Common();
